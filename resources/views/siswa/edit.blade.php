                            ...
                            <div class="form-group">
                                ...
                                <select name="ayah_pendidikan_id"  class="form-control">
                                    @foreach ($pendidikan as $item)
                                        <option {{ $item->pendidikan_id == $ayah->pendidikan_id ? 'selected' : '' }} value="{{ $item->id }}">{{ $item->pendidikan }}</option>
                                    @endforeach
                                </select> 
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="ibu_pekerjaan_id"  class="form-control custom-select2">
                                   @foreach ($pekerjaan as $item)
                                      <option {{ $item->pekerjaan_id == $ibu->pekerjaan_id ? 'selected' : '' }} value="{{ $item->id }}">{{ $item->pekerjaan }}</option>
                                   @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="ibu_pendidikan_id"  class="form-control">
                                    @foreach ($pendidikan as $item)
                                        <option {{ $item->pendidikan_id == $ibu->pendidikan_id ? 'selected' : '' }} value="{{ $item->id }}">{{ $item->pendidikan }}</option>
                                    @endforeach
                                </select> 
                            </div>
                        </div>
